...
school_coll.remove()
school_file = open("ny_schools_v2.csv", encoding="utf8", "r")
school_list = list()
...
major_coll = db.major
major_coll.remove()
major_file = open("major_mapping.csv", encoding="utf8", "r")
major_list = list()
...
degrees_coll.remove()
degrees_file = open("degrees_mapping.csv", encoding="utf8", "r")
degrees_list = list()
...
region_coll.remove()
region_file = open("region_mapping.csv", encoding="utf8", "r")
region_list = list()
...
state_coll = db.state
state_coll.remove()
state_file = open("state_mapping.csv", encoding="utf8", "r")
state_list = list()
